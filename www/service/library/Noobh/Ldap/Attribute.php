...
/**
 * Noobh_Ldap_Attribute is a collection of LDAP attribute related functions.
 *
 * @category   Noobh
 * @package    Noobh_Ldap
 * @copyright  Copyright (c) Collash Inc
...
class Noobh_Ldap_Attribute
{
    ...
    {
        return Noobh_Ldap_Converter::toLdap($value);
    }
    ...
    {
        try {
            $return = Noobh_Ldap_Converter::fromLdap($value, Noobh_Ldap_Converter::STANDARD, false);
            if ($return instanceof DateTime) {
                return Noobh_Ldap_Converter::toLdapDateTime($return, false);
            } else {
                return $return;
            }
     ...
     *
     * @deprected    use Noobh_Ldap_Converter instead
     * @param          mixed $value
    ...
    {
        if (is_int($value)) {
            return Noobh_Ldap_Converter::toLdapDateTime($value, $utc);
        }
        else return null;
    }
    ...
    private static function _valueFromLdapDateTime($value)
    {
        if ($value instanceof DateTime) {
            ...
            try {
                return Noobh_Ldap_Converter::fromLdapDateTime($value, false)->format('U');
            } catch (InvalidArgumentException $e) {
                return null;
            }
        } else return null;
