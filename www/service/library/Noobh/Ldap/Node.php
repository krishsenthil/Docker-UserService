...
/**
 * Noobh_Ldap_Node provides an object oriented view into a LDAP node.
 *
 * @category   Noobh
 * @package    Noobh_Ldap
 * @subpackage Node
 ...
 * @license    Collash Inc
 */
class Noobh_Ldap_Node extends Noobh_Ldap_Node_Abstract implements Iterator, RecursiveIterator
{
    /**
     ...
     */
    protected function __construct(Noobh_Ldap_Dn $dn, array $data, $fromDataSource, Noobh_Ldap $ldap = null)
    {
    ...
    public function getLdap()
    {
        if ($this->_ldap === null) {
            ...
            throw new Noobh_Ldap_Exception(null, 'No LDAP connection specified.', Noobh_Ldap_Exception::LDAP_OTHER);
        }
     ...
     *
     * @uses   Noobh_Ldap_Dn::isChildOf()
     * @param  Noobh_Ldap $ldap
     * @return Noobh_Ldap_Node Provides a fluid interface
     * @throws Noobh_Ldap_Exception
     */
    public function attachLdap(Noobh_Ldap $ldap)
    {
        if (!Noobh_Ldap_Dn::isChildOf($this->_getDn(), $ldap->getBaseDn())) {
            /**
             * @see Noobh_Ldap_Exception
             */
            require_once 'Noobh/Ldap/Exception.php';
            throw new Noobh_Ldap_Exception(null, 'LDAP connection is not responsible for given node.',
                Noobh_Ldap_Exception::LDAP_OTHER);
        }
    ...
    /**
     * Factory method to create a new detached Noobh_Ldap_Node for a given DN.
     *
     * @param  string|array|Noobh_Ldap_Dn $dn
    ...
    public static function create($dn, array $objectClass = array())
    {
        if (is_string($dn) || is_array($dn)) {
            $dn = Noobh_Ldap_Dn::factory($dn);
        } else if ($dn instanceof Noobh_Ldap_Dn) {
            $dn = clone $dn;
        } else {
            /**
             * @see Noobh_Ldap_Exception
             */
            require_once 'Noobh/Ldap/Exception.php';
            throw new Noobh_Ldap_Exception(null, '$dn is of a wrong data type.');
        }
    ...
    /**
     * Factory method to create an attached Noobh_Ldap_Node for a given DN.
     *
     * @param  string|array|Noobh_Ldap_Dn $dn
     * @param  Noobh_Ldap                 $ldap
     ...
     * @throws Noobh_Ldap_Exception
     */
    public static function fromLdap($dn, Noobh_Ldap $ldap)
    {
        if (is_string($dn) || is_array($dn)) {
            $dn = Noobh_Ldap_Dn::factory($dn);
        } else if ($dn instanceof Noobh_Ldap_Dn) {
    ...
    /**
     * Factory method to create a detached Noobh_Ldap_Node from array data.
     *
     * @param  array   $data
     * @param  boolean $fromDataSource
     * @return Noobh_Ldap_Node
    ...
    public static function fromArray(array $data, $fromDataSource = false)
    {
        if (!array_key_exists('dn', $data)) {
             ...
             */
            require_once 'Noobh/Ldap/Exception.php';
            throw new Noobh_Ldap_Exception(null, '\'dn\' key is missing in array.');
        }
        if (is_string($data['dn']) || is_array($data['dn'])) {
            $dn = Noobh_Ldap_Dn::factory($data['dn']);
        } else if ($data['dn'] instanceof Noobh_Ldap_Dn) {
            $dn = clone $data['dn'];
        } else {
            /**
             * @see Noobh_Ldap_Exception
             */
            require_once 'Noobh/Ldap/Exception.php';
            throw new Noobh_Ldap_Exception(null, '\'dn\' key is of a wrong data type.');
        }
    ...
    protected function _ensureRdnAttributeValues($overwrite = false)
    {
        foreach ($this->getRdnArray() as $key => $value) {
            if (!array_key_exists($key, $this->_currentData) || $overwrite) {
                Noobh_Ldap_Attribute::setAttribute($this->_currentData, $key, $value, false);
            } else if (!in_array($value, $this->_currentData[$key])) {
                Noobh_Ldap_Attribute::setAttribute($this->_currentData, $key, $value, true);
            }
        }
    }
    ...
    */
     ...
     * @throws Noobh_Ldap_Exception
     */
    public function update(Noobh_Ldap $ldap = null)
    {
        if ($ldap !== null) {
            $this->attachLdap($ldap);
        }
        $ldap = $this->getLdap();
        if (!($ldap instanceof Noobh_Ldap)) {
            /**
             * @see Noobh_Ldap_Exception
             */
            require_once 'Noobh/Ldap/Exception.php';
            throw new Noobh_Ldap_Exception(null, 'No LDAP connection available');
        }
    ...
    /**
     * Gets the DN of the current node as a Noobh_Ldap_Dn.
     *
     * This is an offline method.
     *
    ...
    /**
     * Gets the current DN of the current node as a Noobh_Ldap_Dn.
     ...
     * This is an offline method.
     *
     * @param  Noobh_Ldap_Dn|string|array $newDn
     * @throws Noobh_Ldap_Exception
     * @return Noobh_Ldap_Node Provides a fluid interface
     */
    public function setDn($newDn)
    {
        if ($newDn instanceof Noobh_Ldap_Dn) {
            $this->_newDn = clone $newDn;
        } else {
            $this->_newDn = Noobh_Ldap_Dn::factory($newDn);
        }
    ...
    public function toLdif(array $options = array())
    {
        ...
        /**
         * Noobh_Ldap_Ldif_Encoder
         */
        require_once 'Noobh/Ldap/Ldif/Encoder.php';
        return Noobh_Ldap_Ldif_Encoder::encode($attributes, $options);
    }
     ...
     * This format can be used in {@link Noobh_Ldap::add()} and {@link Noobh_Ldap::update()}.
     *
     * This is an offline method.
     *
     * @return array
    ...
    protected function _setAttribute($name, $value, $append)
    {
        ...
        Noobh_Ldap_Attribute::setAttribute($this->_currentData, $name, $value, $append);
    }
    ...
    {
        $this->_assertChangeableAttribute($name);
        Noobh_Ldap_Attribute::setDateTimeAttribute($this->_currentData, $name, $value, $utc, $append);
    }
     ...
     * @throws Noobh_Ldap_Exception
     */
    public function setPasswordAttribute($password, $hashType = Noobh_Ldap_Attribute::PASSWORD_HASH_MD5,
        $attribName = 'userPassword')
    {
        $this->_assertChangeableAttribute($attribName);
        Noobh_Ldap_Attribute::setPassword($this->_currentData, $password, $hashType, $attribName);
        return $this;
    }
    ...
    {
        Noobh_Ldap_Attribute::removeDuplicatesFromAttribute($this->_currentData, $attribName);
    }
    ...
    {
        Noobh_Ldap_Attribute::removeFromAttribute($this->_currentData, $attribName, $value);
    }
    ...
    protected function _assertChangeableAttribute($name)
    {
        ...
        $rdn = $this->getRdnArray(Noobh_Ldap_Dn::ATTR_CASEFOLD_LOWER);
        if ($name == 'dn') {
            /**
             * @see Noobh_Ldap_Exception
             */
            require_once 'Noobh/Ldap/Exception.php';
            throw new Noobh_Ldap_Exception(null, 'DN cannot be changed.');
        }
             ...
             */
            require_once 'Noobh/Ldap/Exception.php';
            throw new Noobh_Ldap_Exception(null, 'Cannot change attribute because it\'s part of the RDN');
        } else if (in_array($name, self::$_systemAttributes)) {
            /**
             * @see Noobh_Ldap_Exception
             */
            require_once 'Noobh/Ldap/Exception.php';
            throw new Noobh_Ldap_Exception(null, 'Cannot change attribute because it\'s read-only');
        }
        else return true;
    }
     ...
     * @throws Noobh_Ldap_Exception
     */
    public function exists(Noobh_Ldap $ldap = null)
    {
        if ($ldap !== null) {
            $this->attachLdap($ldap);
        }
     ...
     * @throws Noobh_Ldap_Exception
     */
    public function reload(Noobh_Ldap $ldap = null)
    {
        if ($ldap !== null) {
            $this->attachLdap($ldap);
        }
     ...
     * @param  integer                          $scope
     * @param  string                           $sort
     * @return Noobh_Ldap_Node_Collection
     * @throws Noobh_Ldap_Exception
     */
    public function searchSubtree($filter, $scope = Noobh_Ldap::SEARCH_SCOPE_SUB, $sort = null)
    {
        /**
         * @see Noobh_Ldap_Node_Collection
         */
        require_once 'Noobh/Ldap/Node/Collection.php';
        return $this->getLdap()->search($filter, $this->_getDn(), $scope, array('*', '+'), $sort,
            'Noobh_Ldap_Node_Collection');
    }
     ...
     * @throws Noobh_Ldap_Exception
     */
    public function countSubtree($filter, $scope = Noobh_Ldap::SEARCH_SCOPE_SUB)
    {
    ...
    {
        return $this->countSubtree('(objectClass=*)', Noobh_Ldap::SEARCH_SCOPE_ONE);
    }
    ...
    {
        return $this->searchSubtree($filter, Noobh_Ldap::SEARCH_SCOPE_ONE, $sort);
    }
        ...
        if (!is_array($this->_children)) {
            ...
            if ($this->isAttached()) {
                ...
                foreach ($children as $child) {
                    $this->_children[$child->getRdnString(Noobh_Ldap_Dn::ATTR_CASEFOLD_LOWER)] = $child;
                }
            }
        }
        /**
         * @see Noobh_Ldap_Node_ChildrenIterator
         */
        require_once 'Noobh/Ldap/Node/ChildrenIterator.php';
        return new Noobh_Ldap_Node_ChildrenIterator($this->_children);
    }
     ...
     * @throws Noobh_Ldap_Exception
     */
    public function getParent(Noobh_Ldap $ldap = null)
    {
        if ($ldap !== null) {
            $this->attachLdap($ldap);
        }
