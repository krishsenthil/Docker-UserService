...
/**
 * @see Noobh_Ldap_Attribute
 */
require_once 'Noobh/Ldap/Attribute.php';
/**
 * @see Noobh_Ldap_Dn
 */
...
/**
 * Noobh_Ldap_Node_Abstract provides a bas eimplementation for LDAP nodes
 *
 * @category   Noobh
 * @package    Noobh_Ldap
 * @subpackage Node
 ...
 * @license    Collash Inc
 */
abstract class Noobh_Ldap_Node_Abstract implements ArrayAccess, Countable
{
     ...
     */
    protected function __construct(Noobh_Ldap_Dn $dn, array $data, $fromDataSource)
    {
        $this->_dn = $dn;
     ...
     * @return Noobh_Ldap_Node_Abstract Provides a fluid interface
     * @throws Noobh_Ldap_Exception
     */
    ...
    {
        return Noobh_Ldap_Attribute::attributeHasValue($this->_currentData, $attribName, $value);
    }
    ...
    public function getAttribute($name, $index = null)
    {
        if ($name == 'dn') {
            ...
            return Noobh_Ldap_Attribute::getAttribute($this->_currentData, $name, $index);
        }
    }
    ...
    {
        return Noobh_Ldap_Attribute::getDateTimeAttribute($this->_currentData, $name, $index);
    }
