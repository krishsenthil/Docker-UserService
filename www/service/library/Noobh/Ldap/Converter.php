...
/**
 * Noobh_Ldap_Converter is a collection of useful LDAP related conversion functions.
 *
 * @category   Noobh
 * @package    Noobh_Ldap
 * @copyright  Copyright (c) Collash Inc
...
class Noobh_Ldap_Converter
{
     ...
     * @return    string
     * @throws    Noobh_Ldap_Converter_Exception
     */
    public static function toLdap($value, $type = self::STANDARD)
    {
        try {
            ...
            throw new Noobh_Ldap_Converter_Exception($e->getMessage(), $e->getCode(), $e);
        }
    }
     ...
     * DateTime Object, a string that is parseable by strtotime() or a Noobh_Date
     * Object.
     *
     * @param    integer|string|DateTimt|Noobh_Date        $date    The date-entity
