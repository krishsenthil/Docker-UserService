 ...
 * @category   Noobh
 * @package    Noobh_Ldap
 * @uses       Noobh_Exception
 * @copyright  Copyright (c) Collash Inc
 * @license    Collash Inc
 */
class Noobh_Ldap_Exception extends Noobh_Exception
{
    ...
    /**
     * @param Noobh_Ldap $ldap A Noobh_Ldap object
     * @param string    $str  An informtive exception message
     * @param int       $code An LDAP error code
     */
    public function __construct(Noobh_Ldap $ldap = null, $str = null, $code = 0)
    {
        $errorMessages = array();
        $message = '';
        if ($ldap !== null) {
     ...
     */
    public static function getLdapCode(Noobh_Ldap $ldap = null)
    {
        if ($ldap !== null) {
