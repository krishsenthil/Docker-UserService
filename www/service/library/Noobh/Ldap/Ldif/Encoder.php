...
/**
 * Noobh_Ldap_Ldif_Encoder provides methods to encode and decode LDAP data into/from LDIF.
 *
 * @category   Noobh
 * @package    Noobh_Ldap
 * @subpackage Ldif
...
class Noobh_Ldap_Ldif_Encoder
{
    ...
    protected function _encode($value)
    {
        ...
        } else if ($value instanceof Noobh_Ldap_Node) {
