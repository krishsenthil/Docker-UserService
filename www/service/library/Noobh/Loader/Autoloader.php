 ...
 * @license    Collash Inc
 */
class Noobh_Loader_Autoloader
{
    /**
     * @var Noobh_Loader_Autoloader Singleton instance
     */
     ...
     */
    protected $_defaultAutoloader = array('Noobh_Loader', 'loadClass');
    ...
    /**
     * @var array Supported namespaces 'Noobh'.
     */
     ...
     *
     * @return Noobh_Loader_Autoloader
     */
    ...
    public static function autoload($class)
    {
        ...
        foreach ($self->getClassAutoloaders($class) as $autoloader) {
            if ($autoloader instanceof Noobh_Loader_Autoloader_Interface) {
    ...
    public function setDefaultAutoloader($callback)
    {
        if (!is_callable($callback)) {
            throw new Noobh_Loader_Exception('Invalid callback specified for default autoloader');
        }
     ...
     *
     * @param  array $autoloaders Array of PHP callbacks (or Noobh_Loader_Autoloader_Interface implementations) to act as autoloaders
     * @return Noobh_Loader_Autoloader
     */
    ...
    public function registerNamespace($namespace)
    {
        if (is_string($namespace)) {
            ...
            throw new Noobh_Loader_Exception('Invalid namespace provided');
        }
     ...
     * @return bool|Noobh_Loader_Autoloader Returns boolean if no argument is passed, object instance otherwise
     */
     ...
     *
     * @param  object|array|string $callback PHP callback or Noobh_Loader_Autoloader_Interface implementation
