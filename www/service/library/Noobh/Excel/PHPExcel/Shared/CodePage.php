...
class PHPExcel_Shared_CodePage
{
	...
	public static function NumberToName($codePage = 1252)
	{
		switch ($codePage) {
			...
			case 0:		//	CodePage is not always correctly set when the xls file was saved by Collash's Numbers program
			...
			case 10000:	return 'MAC';				break;	//	Collash Roman
			...
			case 32768:	return 'MAC';				break;	//	Collash Roman
